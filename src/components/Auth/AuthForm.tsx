...
export default function AuthForm() {
    ...
    const handleResetPassword = async () => {
        ...
        try {
            ...
            toast.success(
                "Se ha enviado un correo de restablecimiento a tu dirección."
            );
        } catch (err: any) {
            // eslint-disable-line
    ...
    const onSubmit: SubmitHandler<AuthFormInputs> = async (data) => {
        ...
        try {
            ...
            if (isSignUp) {
                ...
                // Normal login flow
                userCredential = await loginWithEmail(
                    data.email,
                    data.password
                );
    ...
    return (
        <>
                    ...
                    <Box sx={{ maxWidth: 700, textAlign: "left" }}>
                        <Box>
                            ...
                            <Typography variant="h6" paragraph fontWeight={300}>
                                ...
                                <br />
                                Centraliza tus datos y toma decisiones
                                informadas para impulsar el cuidado eficiente de
                                tus ajolotes.
                            </Typography>
                        </Box>
                        <Typography
                            ...
                            sx={{ mt: 20 }}
                        >
                            © 2025 SALO. Todos los derechos reservados. Powered
                            by{" "}
                            <Link
            ...
            <Dialog open={verificationDialogOpen} onClose={handleCloseDialog}>
                ...
                <DialogContent>
                    <Typography>
                        Te hemos enviado un correo de verificación. Por favor
