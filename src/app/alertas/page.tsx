...
export default function AlertsAndNotifications() {
    ...
    const statCardsData = [
        {
            icon: (
                <ShieldEllipsis size={24} color={theme.palette.primary.main} />
            ),
            title: "Total Alertas Activas",
            value: "20",
        },
        {
            icon: <ShieldAlert size={24} color={theme.palette.primary.main} />,
            title: "Alertas Pendientes",
            value: "10",
        },
        {
            icon: <ShieldCheck size={24} color={theme.palette.primary.main} />,
            title: "Alertas Atendidas",
            value: "5",
        },
        {
            icon: <ShieldX size={24} color={theme.palette.primary.main} />,
                    ...
                    >
                        <Box>
                            ...
                            <Typography variant="body2" sx={{ mt: 1 }}>
                                Revisa las alertas de próximas vacunaciones,
                                revisiones y otros eventos críticos.
                            </Typography>
                        </Box>
